...
Updated to have an option to NOT sample tasks (and just return 2 tasks)"""
import numpy as np
...
class HalfCheetahDirEnv(HalfCheetahEnvMetaBase):
    ...
    def __init__(self, task=None, sample_tasks=False):
        self._sample_tasks = sample_tasks
        directions = [-1, 1]
        self.tasks = [{'direction': direction} for direction in directions]

        super().__init__(task or {'direction': 1.}) #this sets self._task
