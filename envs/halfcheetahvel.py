...
from envs.halfcheetah import HalfCheetahEnvMetaBase
...
class HalfCheetahVelEnv(HalfCheetahEnvMetaBase):
    ...
    Code is from
    https://github.com/rlworkgroup/garage/blob/2d594803636e341660cab0e81343abbe9a325353/src/garage/envs/mujoco/half_cheetah_vel_env.py
